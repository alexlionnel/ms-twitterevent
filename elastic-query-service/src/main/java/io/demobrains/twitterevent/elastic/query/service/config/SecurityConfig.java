...
import io.demobrains.twitterevent.elastic.query.service.security.TwitterQueryUserDetailsService;
import io.demobrains.twitterevent.elastic.query.service.security.TwitterQueryUserJwtConverter;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .and()
                .oauth2ResourceServer().jwt().jwtAuthenticationConverter(twitterQueryUserJwtConverter());
    }
