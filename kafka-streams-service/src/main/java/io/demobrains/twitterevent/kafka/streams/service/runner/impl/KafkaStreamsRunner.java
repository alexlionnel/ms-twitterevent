package io.demobrains.twitterevent.kafka.streams.service.runner.impl;

import io.confluent.kafka.streams.serdes.avro.SpecificAvroSerde;
import io.demobrains.twitterevent.dataconfig.config.KafkaConfigData;
import io.demobrains.twitterevent.dataconfig.config.KafkaStreamsConfigData;
...
public class KafkaStreamsRunner implements StreamsRunner<String, Long> {
    ...
    private void createTopology(KStream<Long, TwitterAvroModel> twitterAvroModelKStream,
        ...
        twitterAvroModelKStream
                ...
                .count(Materialized
                        .as(kafkaStreamsConfigData.getWordCountStoreName()))
                .toStream()
