...
import io.demobrains.twitterevent.dataconfig.config.ElasticQueryconfigData;
...
import io.demobrains.twitterevent.elasticqueryclient.util.ElasticQueryUtil;
...
public class TwitterElasticQueryClient implements ElasticQueryClient<TwitterIndexModel> {
    ...
    public List<TwitterIndexModel> getIndexModelByText(String text) {
        Query query = elasticQueryUtil.getSearchQueryByFilterText(elasticQueryconfigData.getTextfield(), text);
